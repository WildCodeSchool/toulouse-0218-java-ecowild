...
public class OwRenderingGlass extends DefaultClusterRenderer<MyItem> {

    Context mContext;

    /** Avec la precieuse aide de Bastien **/

    public OwRenderingGlass(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
