...
public class LoadAPISingleton {
    ...
    public void loadAPIs(Context context, final LoadAPIListener listener) {
        ...
        String urlGlass = "https://data.toulouse-metropole.fr/api/records/1.0/search/?dataset=recup-verre&refine.commune=TOULOUSE&rows=30";
        ...
        String urlPaper = "https://data.toulouse-metropole.fr/api/records/1.0/search/?dataset=recup-emballage&refine.commune=TOULOUSE&rows=30";
